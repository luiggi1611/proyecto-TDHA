...
$(document).ready(function(){
	...
	************************************/
    ...
    $(".ac-remote-datasource").autocomplete({
        source: "../../../static/app-assets/data/jquery-ui/search.php",
        minLength: 2
    });
    ...
    $(".ac-remote-caching").autocomplete({
        ...
        source: function(request, response) {
            ...
            $.getJSON("../../../static/app-assets/data/jquery-ui/search.php", request, function(data, status, xhr) {
                cache[term] = data;
                response(data);
            });
        }
    ...
    .autocomplete({
        source: function(request, response) {
            $.getJSON("../../../static/app-assets/data/jquery-ui/search.php", {
    ...
    // XML Data Pasing
    $.ajax({
        url: "../../../static/app-assets/data/jquery-ui/london.xml",
        dataType: "xml",
