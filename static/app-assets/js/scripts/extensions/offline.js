...
$(document).ready(function(){
	...
	$('.browser iframe').each(function(){
        ...
        doc.open();
        doc.write('' +
            '<link rel="stylesheet" href="../../../static/app-assets/vendors/css/extensions/offline/themes/offline-theme-' + themeName + '.css" />' +
            '<link rel="stylesheet" href="../../../static/app-assets/vendors/css/extensions/offline/themes/offline-language-english' + (themeName.match(/\-indicator$/) ? '-indicator' : '') + '.css" />' +
